...
urlpatterns = [
    ...
    path('service/change/<int:pk>/<str:type_request>', views.ChangeStatusServiceView.as_view(), name='change_status'),
    path('service/<int:pk>/delivery/', views.DeliveryView.as_view(), name='delivery'),
]
